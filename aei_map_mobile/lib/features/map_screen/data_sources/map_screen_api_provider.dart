...
class MapApiProvider {
  ...
  Future <AllPaths> drawPathFromCoordinates(BuildContext context, int floorNumber) async {
    String data = await DefaultAssetBundle.of(context).loadString("assets/json/path.json");
